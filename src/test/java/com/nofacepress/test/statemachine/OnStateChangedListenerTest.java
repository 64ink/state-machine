...
public class OnStateChangedListenerTest {
	...
	public void test_GraphWide() throws IOException {
		...
		OnStateChangedListener<TestStates, TestEvents, String> listener = Mockito.mock(OnStateChangedListener.class);
	...
	public void test_PerStatee() throws IOException {
		...
		@SuppressWarnings("unchecked")
		OnStateChangedListener<TestStates, TestEvents, String> listener1 = Mockito.mock(OnStateChangedListener.class);
		@SuppressWarnings("unchecked")
		OnStateChangedListener<TestStates, TestEvents, String> listener2 = Mockito.mock(OnStateChangedListener.class);
	...
	class FireListener implements OnStateChangedListener<TestStates, TestEvents, String> {
		@Override
		public void onStateChanged(StateMachineInstance<TestStates, TestEvents, String> instance,
				...
				instance.fireEvent(TestEvents.EVENT_1);
		}
	}
	...
	public void test_ImmediateFireEvent() throws IOException {
		...
		OnStateChangedListener<TestStates, TestEvents, String> listener = new FireListener();;
